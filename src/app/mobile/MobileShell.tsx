  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 top-0 z-40">
        {/* header reads like a sheet from the top: taller, rounded bottom corners */}
        <header
          className="pointer-events-auto flex items-center justify-between gap-2 rounded-b-2xl bg-surface-1 px-4 pb-2.5 shadow-3"
        ...
        {/* date + filter chips + search wrap onto new rows before reaching fullscreen */}
