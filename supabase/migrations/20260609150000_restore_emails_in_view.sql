-- The previous migration recreated v_flights_with_airports from the pre-emails
-- definition, dropping b.emails. Recreate it with emails restored (f.* still picks
-- up the new AeroAPI extra columns added in the previous migration).
